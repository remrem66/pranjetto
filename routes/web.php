...
Route::get('/CancelledReservations/{status_id}', 'AdminController@CancelledReservations')->name('CancelledReservations');
Route::get('/ExpiredReservations/{status_id}', 'AdminController@ExpiredReservations')->name('ExpiredReservations');
