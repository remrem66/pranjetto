...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2020 at 05:45 PM
...
CREATE TABLE `walkin_reservation_tbl` (
  ...
  `contact_num` varchar(250) NOT NULL,
  `room_id` int(10) NOT NULL,
  `reservation_code` varchar(250) NOT NULL,
...
INSERT INTO `walkin_reservation_tbl` (`walkin_id`, `customer_name`, `email`, `contact_num`, `room_id`, `reservation_code`, `no_of_persons`, `extra_mattress`, `check_in`, `check_out`, `quantity`, `total_price`, `amount_paid`, `reservation_status`, `date`) VALUES
(2, 'Robert Acuyan', 'rhemacuyan@gmail.com', '9977233740', 2, 'def123', 1, 0, '2020-02-13', '2020-02-14', 1, '2400', NULL, 0, '2020-02-13 16:27:04');
